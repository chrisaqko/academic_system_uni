  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/login"
              className="px-4 py-2 text-xs font-semibold bg-primary-700 text-white rounded-lg hover:bg-primary-800 shadow-soft transition-colors"
            >
              Apply Now
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-br from-slate-50 via-primary-50/20 to-white" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-xl">
              ...
              <p className="text-base text-slate-500 leading-relaxed mb-8 max-w-md">
                ...
                Managing academic rigor through precision data, intuitive
                interfaces, and institutional legacy.
              </p>
              <div className="flex items-center gap-3">
                <Link
                  href="/login"
                  className="inline-flex items-center gap-2 px-5 py-3 bg-primary-700 text-white text-sm font-semibold rounded-xl hover:bg-primary-800 shadow-soft transition-all"
                >
            ...
            <div className="relative hidden lg:block">
              <div className="relative rounded-2xl overflow-hidden shadow-card border border-slate-200">
                ...
                />
                <div className="absolute bottom-0 inset-x-0 bg-linear-to-t from-primary-900/80 to-transparent p-5">
                  <div className="flex items-center gap-2 mb-1">
                    <Globe size={12} className="text-primary-300" />
                    <span className="text-[10px] font-bold text-primary-300 tracking-widest uppercase">
                      Global Ranking
                    </span>
                  </div>
                  <p className="text-sm font-semibold text-white">
                    Top 5% Globally for Research Innovation
                  </p>
                </div>
              </div>
            </div>
                ...
                >
                  ...
                  >
                    <Icon
                      size={18}
                      className={
                        area.highlight ? "text-white" : "text-primary-700"
                      }
                    />
                  </div>
                  {area.featured && (
                  ...
                  <h3
                    className={`text-base font-semibold mb-2 ${area.highlight ? "text-white" : "text-slate-900"}`}
                  >
                    {area.title}
                  </h3>
                  <p
                    className={`text-xs leading-relaxed mb-3 ${area.highlight ? "text-white/70" : "text-slate-500"}`}
                  >
                    {area.desc}
                  </p>
                  {area.cta && (
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {STATS.map((s, i) => (
            <div key={i} className="text-center">
              ...
              <p className="text-[10px] font-semibold tracking-widest uppercase text-primary-300">
                {s.label}
              </p>
            </div>
          ))}
